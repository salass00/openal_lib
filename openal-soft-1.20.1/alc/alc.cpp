...
const char extversion[] = "\0$EXTVER: openal-soft 1.20.1 (" __AMIGADATE__ ") AmigaOS port by salass00";
#endif
...
#ifdef HAVE_AHI
    { "ahi", AHIBackendFactory::getFactory },
#endif
#ifdef HAVE_JACK
...
#ifdef _DEBUG
LogLevel gLogLevel{LogRef}; //LogLevel gLogLevel{LogWarning};
#else
